...
class AuthenticationClient extends BaseClient
{
    ...
    public array $PasswordSecurityLevel = array("LOW" => 1, "MIDDLE" => 2, "HIGH" => 3);
    /**
    ...
    {
        $user = $this->getCurrentUser();
        $param = new SetUdvParam(UdfTargetType::USER, $user->id, $key, json_encode($value, JSON_THROW_ON_ERROR));
        return $this->request($param->createRequest());
    }
    ...
    public function _getAccessTokenByCodeWithClientSecretPost(string $code, string $codeVerifier = '')
    {
        ...
        return json_decode($stringBody, null, 512, JSON_THROW_ON_ERROR);
    }
